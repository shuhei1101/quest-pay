...
家族クエストAPIは、家族クエストのCRUD操作、公開、子供の受注・報告を管理するAPI群。
...
### 公開機能
- `POST /api/quests/family/[id]/publish`: 公開クエストとして公開
- `GET /api/quests/family/[id]/public`: IDに紐づく公開クエスト取得
...
- `POST /api/quests/family/[id]/child/[childId]/approve`: 報告承認
- `POST /api/quests/family/[id]/child/[childId]/reject`: 報告却下
...
### 操作原則
- Drizzle低レベルクエリを使用
- 複数テーブルの更新はSupabase Database Functionsを使用
