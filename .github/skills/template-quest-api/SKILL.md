...
テンプレートクエストAPIは、システムが提供するクエストテンプレートの取得とFamily Questとしての採用を管理するAPI群。

## API エンドポイント一覧

### 基本CRUD
- `GET /api/quests/template`: 一覧取得
- `GET /api/quests/template/[id]`: 詳細取得
...
- `template_quest_details`: テンプレート詳細（レベル別）
