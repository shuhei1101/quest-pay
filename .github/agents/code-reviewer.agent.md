...
- 複数の修正案を提示
- 改善の優先順位を相談
- code-developerエージェントにハンドオフして具体的な改善案を検討

### ステップ5: レビューサマリー
最後に、レビュー結果をまとめたチェックリストを提供する

### ステップ6: 自身の指示書メンテナンス
レビュー完了後、必要に応じて自身の指示書を更新:
- 頻繁に発生する規約違反やアンチパターンを「よくある間違いパターン」に追加
- 新しいプロジェクト規約や推奨パターンを発見した場合は記録
- レビュー項目やチェックリストの改善が必要な場合は更新
- 新規スキルやエージェントが必要な場合は`@repo-architect`に依頼
...
- **改善案の検討**: code-developerエージェントにハンドオフして、複数の改善オプションを検討
