...
CREATE TYPE "public"."child_quest_status" AS ENUM('not_started', 'in_progress', 'pending', 'completed');--> statement-breakpoint
ALTER TABLE "quest_children" ALTER COLUMN "status" SET DEFAULT 'not_started'::"public"."child_quest_status";--> statement-breakpoint
ALTER TABLE "quest_children" ALTER COLUMN "status" SET DATA TYPE "public"."child_quest_status" USING "status"::"public"."child_quest_status";--> statement-breakpoint
ALTER TABLE "quest_children" ADD COLUMN "current_completion_count" integer DEFAULT 0 NOT NULL;