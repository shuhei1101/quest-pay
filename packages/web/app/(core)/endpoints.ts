...
export const TEST_ERROR_NETWORK_URL = `${TEST_URL}/error-network`
export const TEST_ERROR_TIMEOUT_URL = `${TEST_URL}/error-timeout`
export const TEST_ERROR_DATA_URL = `${TEST_URL}/error-data`
export const TEST_ERROR_SERVER_URL = `${TEST_URL}/error-server`
