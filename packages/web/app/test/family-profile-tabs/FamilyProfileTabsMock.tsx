...
import { Box, Tabs, Card, Group, Stack, Text, Badge, ThemeIcon, SimpleGrid, Divider, Button } from "@mantine/core"
...
/** パターン1: タブ切り替え方式 */
export const FamilyProfileTabsMock = () => {
  ...
  return (
    <Box p="md">
      <PageHeader title="家族プロフィール（タブ切り替え方式）" showProfileButton={false} />
      ...
      <Tabs defaultValue="profile" variant="outline">
        <Tabs.List>
          <Tabs.Tab value="profile" leftSection={<IconHome size={16} />}>
            プロフィール
          </Tabs.Tab>
          <Tabs.Tab value="quests" leftSection={<IconStar size={16} />}>
            公開クエスト
          </Tabs.Tab>
          <Tabs.Tab value="rewards" leftSection={<IconCoin size={16} />}>
            報酬テンプレート
          </Tabs.Tab>
        </Tabs.List>
        ...
        <Tabs.Panel value="quests" pt="md">
          <Card shadow="sm" padding="lg" radius="md" withBorder>
            <Text size="lg" fw={600} mb="md">公開クエスト一覧</Text>
            <Stack gap="md">
        ...
        <Tabs.Panel value="rewards" pt="md">
          <Card shadow="sm" padding="lg" radius="md" withBorder>
            <Text size="lg" fw={600} mb="md">報酬テンプレート</Text>
            <Stack gap="md">
