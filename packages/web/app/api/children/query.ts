...
export const fetchChildRewardStats = async ({db, childId}: {
  ...
  try {
    ...
    devLog("fetchChildRewardStats.報酬データ: ", rewardData, "app/api/children/query.ts")
    ...
    devLog("fetchChildRewardStats.取得例外: ", error, "app/api/children/query.ts")
...
export const fetchChildFixedReward = async ({db, childId, age, level}: {
  ...
  try {
    ...
    devLog("fetchChildFixedReward.取得データ: ", { ageReward, levelReward }, "app/api/children/query.ts")
    ...
    devLog("fetchChildFixedReward.取得例外: ", error, "app/api/children/query.ts")
