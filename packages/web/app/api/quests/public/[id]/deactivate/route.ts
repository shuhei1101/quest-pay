...
export async function PUT(
  ...
  return withRouteErrorHandling(async () => {
    logger.info('公開クエスト無効化API開始', {
      path: '/api/quests/public/[id]/deactivate',
      method: 'PUT',
    })
    ...
    logger.debug('公開クエスト無効化完了', { publicQuestId: id })
    
    logger.info('公開クエスト無効化成功', { publicQuestId: id })
